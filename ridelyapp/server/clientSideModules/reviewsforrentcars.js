...
(module.exports = router.post(
  ...
  (module.exports = router.get(
    "/getallreviewsforselectedrentcar",
    authenticate,
    async (req, res) => {
      const findAllReviews = await Rentcarreviews.findOne({
        carById: getReviewRentCarId.id,
      });
  ...
  (module.exports = router.post(
    ...
    async (req, res) => {
      ...
      const findCarReview = await Rentcarreviews.findOne({
        carById: findCarId,
      });
