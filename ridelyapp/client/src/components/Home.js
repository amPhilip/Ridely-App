      ...
      <section className="footer" id="footer">
        <div className="box-container">
          ...
          <div className="box">
            ...
            <a href="#">
              {" "}
              <i className="fas fa-phone"></i>+254 113 879 465
            </a>
            <a href="#">
              {" "}
              <i className="fas fa-phone"></i> +254 798 756 213{" "}
            </a>
            <a href="#">
              {" "}
              <i className="fas fa-envelope"></i> ridely@company.com{" "}
            </a>
            <a href="#">
              {" "}
              <i className="fas fa-map-marker-alt"></i>Nairobi - 10200
            </a>
          </div>
        ...
        <div className="credit">
          {" "}
          created by amphilip | all rights reserved{" "}
        </div>
      </section>
    </>
  );
