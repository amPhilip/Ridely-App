    ...
    <>
      <header className="header">
        ...
        <nav className="navbar">
          ...
          <NavLink className="nav-link" to="/rentcarcart">
            Go To Cart
          </NavLink>
      ...
      <div className="buycarcard">
        {rentCarsData.map((rentCarsData, index) => [
          <div className="cardivRentcar" key={rentCarsData._id}>
            <img
              src={rentCarsData.filePath}
              alt=""
              style={{ width: "80%", height: "70%" }}
            />
            <h4>
              <b>{rentCarsData.brand}</b>
            </h4>
            <p>{rentCarsData.model}</p>

            <div style={{ display: "flex", gap: "15px" }}>
              <button className="cardbtn" id={index} onClick={showDetails}>
                Details
              </button>
              <br />
              <button className="cardbtn" id={index} onClick={addToCart}>
                Add To Cart
              </button>
              <br />
            </div>
          ...
          <div className="specsDivRentcar" key={new Date()}>
            ...
            <p style={{ color: "red" }}>
              Availibility : {rentCarsData.availability + " hours"}
            </p>
            ...
            <div style={{ display: "flex", gap: "15px" }}>
              <button className="cardbtn">
                <NavLink
                  className="nav-link"
                  to={{
                    pathname: "/rentcarreviews",
                    state: { id: rentCarsData._id },
                  }}
                >
                  Car Reviews
                </NavLink>
              </button>
              <button className="cardbtn" id={index} onClick={showCar}>
                show car
              </button>
            </div>
          </div>,
          ...
          <div className="formDivRentcar" key={index}>
            ...
            <button className="cardbtn" id={index} onClick={showCarAgain}>
              show car
            </button>
          </div>,
        ])}
